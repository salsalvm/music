...
class demo extends StatefulWidget {
  List<Audio> allSongs = [];
  int index;
  demo({Key? key, required this.allSongs, required this.index})
      : super(key: key);
      ...
      body: player.builderCurrent(builder: (context, Playing? playing) {
        ...
        return Center(
          child: Stack(children: [
            ...
            Column(
              children: [SizedBox(height:425,),
                Container(width: double.infinity,height: 270,
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: Marquee(
                                      ...
                                      style:
                                          TextStyle(fontSize: 22, color: textWhite),
                                    ),
                                  ),
                                  Text(
